...
description: Little Bit Large Productive Bees Guide
authors:
...
If you're starting out and want to learn more, check out [Rockit14's video!](https://www.youtube.com/watch?v=2CdILcAxPxE) If you want a more advanced guide, check out [Pilpoh's video!](https://www.youtube.com/watch?v=7wg3UQ_AsAA) Also, read the in-game **Productive Bees book**; it has all you need to know including upgrades and how they work, different types of bees, different machines, etc. A glance at the book will help if you get stuck. Also, remember that **JEI** is your best friend.
...
![](img/pb_kamikaze.png){align=right width='400px' height='400px'}
